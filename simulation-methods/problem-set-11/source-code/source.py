...
#grid class: contains all the variables and functions used to evolve the system
class Grid:
    ...
    #function to perform constant reconstruciton (returns left and right states)
