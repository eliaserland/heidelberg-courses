 ...
 * 
 * Version information:
 * 	2020-12-09: v.1.0   First public release.
 */
...
int main(int argc, char **argv) {
	...
	// Input parameters.
	double target_temperature = 400; // Target temperature
